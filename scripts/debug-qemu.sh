...
# QEMU Debug Script
# Usage: ./debug-qemu.sh <gdb-script>
#
# This script:
...
pkill -f "qemu-system-aarch64.*-kernel.*kernel.bin" 2>/dev/null
...
# Source our .gdbinit for higher-half kernel support
source $SCRIPT_DIR/.gdbinit
